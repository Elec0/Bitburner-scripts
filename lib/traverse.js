 ...
 * @param {boolean} [traverseType.killScript = false] - Kills all if scriptName is blank
 * @param {string} [traverseType.scriptName = ""] - What script name to kill, if any
 * @param {boolean} [traverseType.killOurs = false] - If killOurs is false, all {@link Constants.MY_SERVERS_PREFIX} will be ignored.
 ...
 */
export async function DfsServer(ns, startServer, visited, callback) {
